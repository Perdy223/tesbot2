...
hydratedFooterText: "© FERRBOTZ ~ FERR",
hydratedButtons: [{
urlButton: {
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© FERRBOTZ ~ FERR", log0, btn, thum)
}
